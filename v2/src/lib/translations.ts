    ...
    experience: {
      ...
      items: [
        ...
        },
        {
          ...
          period: "Jun 2026 — Atual",
          description:
            "Colaboro na construção e sustentação de sistemas web de grande escala, priorizando a entrega constante de novas funcionalidades, o aprimoramento de interfaces e a integridade de APIs.",
          highlights: [
            "Desenvolvimento de funcionalidades end-to-end em ecossistemas web",
            "Otimização de performance e consumo de APIs",
            "Manutenção preventiva e evolução de interfaces de usuário",
          ],
          tags: ["Next.js", "TypeScript", "Node.js", "APIs REST", "Git"],
        },
        {
          role: "Desenvolvedor Full Stack",
          company: "Fintegra",
    ...
    experience: {
      ...
      items: [
        ...
        },
        {
          ...
          period: "Jun 2026 — Present",
          description:
            "Collaborating on the engineering and maintenance of large-scale web systems, delivering new features, UI refinements, and reliable API endpoints.",
          highlights: [
            "End-to-end web feature development",
            "Performance optimization and API consumption",
            "Preventive maintenance and UI component evolution",
          ],
          tags: ["Next.js", "TypeScript", "Node.js", "REST APIs", "Git"],
        },
        {
          role: "Full Stack Developer",
          company: "Fintegra",
